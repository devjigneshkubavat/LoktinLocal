            ...
            <View style={styles.item}>
                <View>
                    ...
                    <Text style={styles.text}>
                        We value your experience on our platform and want to ensure everything runs smoothly. If you encounter any issues, notice a bug, or have concerns about another user, we encourage you to share your feedback with us. Your input is incredibly important in helping us improve and maintain a safe, enjoyable community. Rest assured, any report you make is completely anonymous, so you can share freely with confidence. Thank you for helping us create the best experience possible!
                    </Text>
                </View>
            </View>
                ...
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        <View style={styles.modalHeader}>
                            <Text style={styles.modalTitle}>Can you tell us what happened?</Text>
                        </View>
                        <TextInput
